...
import type { CharacterSummary, DictionaryEntry } from "../shared/types";
...
export function extensionText(key: string, group: string, actor: CharacterSummary, target: CharacterSummary, catalog: Record<string, string>, asset?: DictionaryEntry | null): string {
