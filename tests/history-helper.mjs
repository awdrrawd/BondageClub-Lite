...
export const history = new Function(code('src/storage/history.ts') + ';return {HistoryStore,historyBatch,historyOwner,historyPolicy,retained,localDay,exportHistory,privateRows};')();
