...
test('architecture document is standalone, internally navigable and included in production', async () => {
  ...
  doc.body.innerHTML = readFileSync('docs/architecture/index.html', 'utf8');
  ...
  const built = readFileSync('dist/docs/architecture/index.html', 'utf8');
  ...
  const css = readFileSync('docs/architecture/architecture.css', 'utf8');
